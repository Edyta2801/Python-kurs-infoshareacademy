...
Napisz testy pozytywne i negatywne (z prawidłowymi danymi i nieprawidłowymi)

Dla chętnych:
oprócz zwykłych testów jednostkowych napisz testy używając podejścia data driven testing
"""
...
from code.Day_12.Zadanie_1_odpowiedz import Kursant
